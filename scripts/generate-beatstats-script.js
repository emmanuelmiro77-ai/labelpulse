// Generate the standalone Beatstats v2.1 scraper script for direct console paste
const periodLabel = "current";

const script = `(async function(){'use strict';
...
const fs = require('fs');
fs.writeFileSync('/home/z/my-project/download/beatstats_scraper_v2.1.js', script);
console.log('Script salvato in /home/z/my-project/download/beatstats_scraper_v2.1.js');
console.log('Lunghezza:', script.length, 'caratteri');
